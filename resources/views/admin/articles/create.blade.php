...
<head>
    ...
    <title>Tambah Artikel | ITENA Admin</title>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">
                                <i class="fas fa-plus-circle mr-2"></i>Form Tambah Artikel
                            </h3>
                        </div>
                            ...
                            <form action="{{ route('admin.articles.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror" 
                                                   value="{{ old('name') }}" placeholder="Masukkan judul artikel..." required>
                                            @error('name')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="slug" id="slug" class="form-control @error('slug') is-invalid @enderror" 
                                                   value="{{ old('slug') }}" placeholder="url-friendly-title">
                                            @error('slug')
                                                <span class="invalid-feedback">{{ $message }}</span>
                                            @enderror
                                            <small class="text-muted">URL: {{ url('/articles') }}/<span id="slug-preview">{{ old('slug') ?: '...' }}</span></small>
                                            <small class="text-muted d-block">Kosongkan untuk generate otomatis dari judul</small>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="description" id="description" rows="10" class="form-control @error('description') is-invalid @enderror" 
                                                      placeholder="Tulis konten artikel..." required>{{ old('description') }}</textarea>
                                            @error('description')
                                                <span class="invalid-feedback">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            <label for="sub_image">Gambar Pendukung</label>
                                            <div class="custom-file">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="sub_description" id="sub_description" rows="3" class="form-control @error('sub_description') is-invalid @enderror" 
                                                      placeholder="Sub deskripsi artikel...">{{ old('sub_description') }}</textarea>
