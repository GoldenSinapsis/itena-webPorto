...
<head>
    ...
    <title>Manajemen Kategori | ITENA Admin</title>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">
                                <i class="fas fa-folder mr-2"></i>Daftar Kategori
                            </h3>
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group input-group-sm">
                                            ...
                                            <span class="input-group-append">
                                                ...
                                                @if(request('search'))
                                                    <a href="{{ route('admin.categories.index') }}" class="btn btn-secondary btn-flat ml-1">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group btn-group-sm">
                                                        ...
                                                        <button type="button" class="btn btn-danger" title="Hapus" data-toggle="modal" data-target="#deleteModal{{ $category->id }}" 
                                                    ...
                                                    @if($category->articles_count > 0)
                                                        <small class="text-muted d-block mt-1">
                                                            <i class="fas fa-info-circle"></i> Tidak bisa dihapus (ada artikel)
                                                        </small>
                                                    @endif
                                        ...
                                        @empty
                                            <tr>
                                                <td colspan="6" class="text-center py-4">
                                                    <i class="fas fa-folder-open fa-3x d-block mb-2 text-muted"></i>
