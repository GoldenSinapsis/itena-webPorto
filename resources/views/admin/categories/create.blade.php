...
<head>
    ...
    <title>Tambah Kategori | ITENA Admin</title>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="slug" id="slug" class="form-control @error('slug') is-invalid @enderror" 
                                                   value="{{ old('slug') }}" placeholder="url-friendly-name" required>
                                            @error('slug')
                                                <span class="invalid-feedback">{{ $message }}</span>
                                            @enderror
                                            <small class="text-muted">URL: {{ url('/categories') }}/<span id="slug-preview">{{ old('slug') ?: '...' }}</span></small>
                                        </div>
